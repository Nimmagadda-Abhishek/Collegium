...
import { users, posts, projects, events } from '@/mocks/data';
...
export default function UserProfileScreen() {
  ...
  const userProjects = projects.filter(p => p.owner.id === id);
  const userEvents = events.filter(e => e.organizer.id === id);
